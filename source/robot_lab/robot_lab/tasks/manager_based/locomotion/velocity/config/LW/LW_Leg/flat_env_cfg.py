...
from .rough_env_cfg import LWLegRoughNormalPPOEnvCfg, LWLegRoughDwaqEnvCfg, LWLegRoughAmpEnvCfg, LWLegRoughAmpDwaqEnvCfg, LWLegRoughAmpRoaEnvCfg, LWLegRoughRoaEnvCfg
...
class LWLegFlatAmpDwaqEnvCfg(LWLegRoughAmpDwaqEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.feet_height_body.weight = 0.0
        self.rewards.bipedal_gait_reward.weight = 5.0 # 2.0
...
@configclass
class LWLegFlatAmpRoaEnvCfg(LWLegRoughAmpRoaEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        # If the weight of rewards is 0, set rewards to None
        if self.__class__.__name__ == "LWLegFlatAmpRoaEnvCfg":
            self.disable_zero_weight_rewards()

@configclass
class LWLegFlatAmpRoaEnvCfg_Play(LWLegFlatAmpRoaEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        ...
        # If the weight of rewards is 0, set rewards to None
        if self.__class__.__name__ == "LWLegFlatAmpRoaEnvCfg_Play":
            self.disable_zero_weight_rewards()
@configclass
class LWLegFlatRoaEnvCfg(LWLegRoughRoaEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        ...
        self.events.randomize_push_robot.params["velocity_range"] = {"x": (-1.0, 1.0), "y": (-1.0, 1.0)}
        self.events.randomize_rigid_body_mass_base.params["mass_distribution_params"] = (0.0, 3.0)
        self.events.randomize_com_positions.params["com_range"] = {"x": (-0.03, 0.03), "y": (-0.03, 0.03), "z": (-0.03, 0.03)}
        self.events.randomize_actuator_gains.params["distribution"] = "uniform"
        self.events.randomize_actuator_gains.params["stiffness_distribution_params"] = (0.9, 1.1)
        self.events.randomize_actuator_gains.params["damping_distribution_params"] = (0.9, 1.1)
        # self.events.randomize_actuator_gains = None
        ...
        # If the weight of rewards is 0, set rewards to None
        if self.__class__.__name__ == "LWLegFlatRoaEnvCfg":
            self.disable_zero_weight_rewards()

@configclass
class LWLegFlatRoaEnvCfg_Play(LWLegFlatRoaEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        ...
        # If the weight of rewards is 0, set rewards to None
        if self.__class__.__name__ == "LWLegFlatRoaEnvCfg_Play":
            self.disable_zero_weight_rewards()
