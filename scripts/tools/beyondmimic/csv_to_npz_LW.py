...
.. code-block:: bash
    ...
    # Usage
    python csv_to_npz.py --input_file source/robot_lab/robot_lab/datasets/LW_Leg/motion_beyondmimic/leg_to_wheel_transform_60hz.csv --input_fps 60  
    --frame_range 3 217 \
    --output_fps 50
"""
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str]):
    ...
    while simulation_app.is_running():
        ...
        if reset_flag and not file_saved:
            ...
            # REGISTRY = "motions"
            # logged_artifact = run.log_artifact(f"{args_cli.output_name}.npz", name=COLLECTION, type=REGISTRY)
